package com.ranosan.challenge.boof.util

import com.ranosan.challenge.boof.data.source.remote.response.movies.DetailResponse
import com.ranosan.challenge.boof.data.source.remote.response.movies.LogosResponseItem
import com.ranosan.challenge.boof.data.source.remote.response.movies.MovieResponseItem
import com.ranosan.challenge.boof.data.source.remote.response.movies.RecommendItem
import com.ranosan.challenge.boof.domain.model.DetailMovie
import com.ranosan.challenge.boof.domain.model.LogoItem
...
fun RecommendItem.toUi() = MovieItemUi(
    overview = overview,
    originalLanguage = originalLanguage,
    originalTitle = originalTitle,
    video = video,
